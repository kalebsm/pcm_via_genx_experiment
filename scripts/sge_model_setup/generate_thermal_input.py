...
# get list of 'Resources' in manual_db_rel that are thermal 'ATB Technology Name'
thermal_names = ['Coal_FE', 'NaturalGas_FE', 'Nuclear']

thermal_resources = manual_db_rel[manual_db_rel['ATB Technology Name'].isin(thermal_names)]['Resource'].tolist()
