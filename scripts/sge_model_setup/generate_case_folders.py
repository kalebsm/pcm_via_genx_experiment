...
for case_name in case_names_list:
    genx_cem_unabr_case_loc = os.path.join(genx_research_path, case_name)
    genx_cem_abbr_case_loc = os.path.join(genx_research_path, case_name + '_abbr')
    spcm_lac_case_loc = os.path.join(spcm_research_path, case_name)
