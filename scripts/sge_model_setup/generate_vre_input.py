...
vre_names = ['LandbasedWind', 'UtilityPV'] # ATB technology names in sheets

# get list of 'Resources' in manual_db_rel that are either Solar or Wind 'ATB Technology Name'
vre_resources = manual_db_rel[manual_db_rel['ATB Technology Name'].isin(vre_names)]['Resource'].tolist()
